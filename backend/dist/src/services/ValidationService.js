...
exports.validateRequest = exports.ValidationService = void 0;
...
class ValidationService {
    ...
    static validateCreatePage(body) {
        const errors = [];
        if (!body || typeof body !== 'object') {
            return (0, value_objects_1.err)([{ field: 'body', message: 'Cuerpo de la solicitud inválido' }]);
        }
    ...
    static validateUpdatePage(body) {
        const errors = [];
        const dto = {};
        if (!body || typeof body !== 'object') {
            return (0, value_objects_1.err)([{ field: 'body', message: 'Cuerpo de la solicitud inválido' }]);
    ...
    static validateCreateComment(body, params) {
        const errors = [];
        if (!body || typeof body !== 'object') {
            return (0, value_objects_1.err)([{ field: 'body', message: 'Cuerpo de la solicitud inválido' }]);
        }
    ...
    static validateUpdateUsername(body) {
        const errors = [];
        if (!body || typeof body !== 'object') {
            return (0, value_objects_1.err)([{ field: 'body', message: 'Cuerpo de la solicitud inválido' }]);
        }
